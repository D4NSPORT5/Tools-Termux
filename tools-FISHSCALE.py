...
while loop == True:
	...
	if kavo == 00:
		if (lang == "Eng") or (lang == "eng"):
			print("===========================")
			print("Please put down your Android and go have some tea...")
			print("(the process is very long)")
			print("===========================")
		else:
			print("===========================")
			print("Пожалуйста, положи свой Андроид и иди попей чаю...")
			print("(процесс очень долгий)")
			print("===========================")
